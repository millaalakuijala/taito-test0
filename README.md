...
> This file has been copied from [server-template](https://github.com/TaitoUnited/server-template/). Keep modifications minimal and improve the original instead. Project specific documentation is located in PROJECT.md.
...
* [API (dev)](https://taito-test0-dev.taitodev.com/api/infra/uptimez)
* [API (prod)](https://taito-test0-prod.taitodev.com/api/infra/uptimez)
* [Admin user interface (dev)](https://taito-test0-dev.taitodev.com/admin/)
* [Admin user interface (prod)](https://taito-test0-prod.taitodev.com/admin/)
* [Application (dev)](https://taito-test0-dev.taitodev.com)
* [Application (prod)](https://taito-test0-prod.taitodev.com)
* [Build logs](https://console.cloud.google.com/gcr/builds?project=gcloud-temp1&query=source.repo_source.repo_name%3D%22github-taitounited-taito-test0%22)
* [Container images](https://console.cloud.google.com/gcr/images/gcloud-temp1/EU/github-taitounited-taito-test0?project=gcloud-temp1)
* [Generated documentation and test reports](https://TODO-DOCS-AND-TEST-REPORTS)
* [Git repository](https://github.com/taitounited/taito-test0)
* [Kanban boards](https://github.com/taitounited/taito-test0/projects)
* [Logs (dev)](https://console.cloud.google.com/logs/viewer?project=gcloud-temp1&minLogLevel=0&expandAll=false&resource=container%2Fcluster_name%2Fkube1%2Fnamespace_id%2Ftaito-test0-dev)
* [Logs (prod)](https://console.cloud.google.com/logs/viewer?project=gcloud-temp1&minLogLevel=0&expandAll=false&resource=container%2Fcluster_name%2Fkube1%2Fnamespace_id%2Ftaito-test0-prod)
* [Performance metrics (New Relic)](https://TODO-NEW-RELIC)
* [Project documentation](https://github.com/taitounited/taito-test0/wiki)
* [Sentry errors (dev)](https://sentry.io/taitounited/taito-test0/?query=is%3Aunresolved+environment%3Adev)
* [Sentry errors (prod)](https://sentry.io/taitounited/taito-test0/?query=is%3Aunresolved+environment%3Aprod)
* [Storage bucket (dev)](https://console.cloud.google.com/storage/browser/taito-test0-dev?project=gcloud-temp1)
* [Storage bucket (prod)](https://console.cloud.google.com/storage/browser/taito-test0-prod?project=gcloud-temp1)
...
Tests are grouped in test suites (see `suite*.sh` and `zuite.sh` files). All test suites are kept independent by cleaning up data before each test suite execution by running `taito init --clean`. If automatic data cleanup is not necessary, you can turn it off with the `ci_exec_test_init` setting in `taito-config.sh`.
...
See [server-template/client/app](https://github.com/TaitoUnited/server-template/tree/master/client/app) as an example.
...
The [server-template](https://github.com/TaitoUnited/server-template/) comes with preconfigured stack components that you can use. Remove stack components that you don't need. You can change the stack by deleting unnecessary directories and modifying the following files:
...
If you later need to add stack components, see [server-template](https://github.com/TaitoUnited/server-template/) for examples.

If you would rather use other technologies than react and node.js, you can copy alternative example implementations from [server-template-alt](https://github.com/TaitoUnited/server-template-alt/).
